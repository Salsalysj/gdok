    ...
    <div className="min-h-full bg-gray-950">
      <div className="py-12 md:py-16">
        ...
        <div className="space-y-6 text-gray-300">
          <section>
            <h2 className="text-lg font-semibold text-white mb-4">개인정보 수집</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-white mb-4">광고</h2>
            <p className="text-lg leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-white mb-4">분석 도구</h2>
            <p className="text-lg leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-white mb-4">문의</h2>
            <p className="text-lg leading-relaxed">
