    ...
    <div className="min-h-full bg-gray-950">
      <div className="py-6 sm:py-8 md:py-12 lg:py-16 sm:px-6">
        ...
        <div className="space-y-3 sm:space-y-4 md:space-y-6 text-gray-300 px-4 sm:px-0">
          <section>
            <h2 className="text-sm sm:text-base md:text-lg font-semibold text-white mb-2 sm:mb-3 md:mb-4">서비스 제공</h2>
          ...
          <section>
            <h2 className="text-sm sm:text-base md:text-lg font-semibold text-white mb-2 sm:mb-3 md:mb-4">서비스 변경 및 중단</h2>
            <p className="text-[10px] sm:text-xs md:text-sm leading-relaxed whitespace-normal break-words">
          ...
          <section>
            <h2 className="text-sm sm:text-base md:text-lg font-semibold text-white mb-2 sm:mb-3 md:mb-4">사용 목적</h2>
            <p className="text-[10px] sm:text-xs md:text-sm leading-relaxed whitespace-normal break-words">
          ...
          <section>
            <h2 className="text-sm sm:text-base md:text-lg font-semibold text-white mb-2 sm:mb-3 md:mb-4">결제 및 구독</h2>
            <p className="text-[10px] sm:text-xs md:text-sm leading-relaxed whitespace-normal break-words">
          ...
          <section>
            <h2 className="text-sm sm:text-base md:text-lg font-semibold text-white mb-2 sm:mb-3 md:mb-4">책임의 제한</h2>
